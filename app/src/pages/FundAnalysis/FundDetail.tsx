              ...
              <Card className="glow-border">
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className={cn("font-medium", (metrics.return?.total_return || 0) >= 0 ? "text-up" : "text-down")}>
                      {formatReturn(metrics.return?.total_return)}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-muted-foreground">年化收益率</span>
                    <span className={cn("font-medium", (metrics.return?.annualized_return || 0) >= 0 ? "text-up" : "text-down")}>
